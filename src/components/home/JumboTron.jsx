  ...
  return (
    <>
      ...
      <div className="w-full h-[390px] bg-image-home bg-cover p-7 flex sm:bg-none sm:flex sm:p-0 md:h-[450px]">
        <div className="w-4/5 text-center sm:w-full sm:flex sm:items-center sm:justify-center sm:flex-col sm:basis-1/2 md:gap-y-1 lg:gap-y-3">
          <h2 className="text-main-1 font-bold text-3xl lg:text-4xl md:-mb-1 font-poetsenOne">
            SHOP WITH US
          </h2>
          <p className="font-semibold font-quicksand xl:text-xl">
