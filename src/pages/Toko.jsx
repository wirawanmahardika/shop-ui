...
import { MobileNavbar, TabletNavbar } from "../components/toko/Navbars";
import {
  BrandForFilter,
  CategoriesForFilter,
  HargaForFilter,
} from "../components/toko/Filters";
import FilterSearch from "../components/toko/FilterSearch";
    ...
    <>
      ...
      <section className="w-full overflow-hidden">
        <Form className="p-5 pt-2 flex-col gap-y-1 flex">
          <h2 className="font-bold  text-2xl -mb-1 font-roboto sm:text-3xl md:text-3xl md:text-main-1 lg:text-yellow-600 lg:text-3xl">
            Search Item
          </h2>
          ...
          <FilterSearch
            ...
            limitHarga={limitHarga}
            setLimitHarga={setLimitHarga}
            resetLimitHargaAndChangeMode={resetLimitHargaAndChangeMode}
            hargaAutoToggle={hargaAutoToggle}
            hargaCustomToggle={hargaCustomToggle}
            hargaToggle={hargaToggle}
