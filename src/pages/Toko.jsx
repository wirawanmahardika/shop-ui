...
export default function Toko() {
    ...
    const hargaCustomToggle =
        hargaToggle === "custom" ? "bg-main-3" : "bg-black";
            ...
            <section className="w-full overflow-hidden">
                <Form className="p-5 pt-2 flex-col gap-y-1 flex">
                    ...
                    <div className="flex md:h-10 items-stretch lg:h-10">
                        ...
                        >
                            <Filter
                                className={"w-8 h-8 md:w-10 md:h-10 my-auto"}
                            />
                        </div>
                    </div>
                    <motion.div
                            ...
                            <div className="flex flex-col gap-y-2 p-3">
                                ...
                                <div className="mx-auto text-center mb-2">
                                    <button
                                        type="button"
                                        onClick={() =>
                                            resetLimitHargaAndChangeMode("auto")
                                        }
                                        className={
                                            "px-2 rounded-l py-0.5 md:px-5 md:py-2 " +
                                            hargaAutoToggle
                                        }
                                    >
                                        Auto
